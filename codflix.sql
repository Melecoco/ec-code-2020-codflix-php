...
--
-- Hôte : localhost:8889
-- Généré le :  jeu. 25 juin 2020 à 18:13
...
(1408, 3, 'House', 'série', 'publié', '2004-11-16', 'Dr. Gregory House, a drug-addicted, unconventional, misanthropic medical genius, leads a team of diagnosticians at the fictional Princeton–Plainsboro Teaching Hospital in New Jersey.', '', 'https://image.tmdb.org/t/p/w300//lkvhReTBZ2Ksl0Dl5Oplsf6UYkF.jpg'),
...
(63247, 3, 'Westworld', 'série', 'publié', '2016-10-02', 'A dark odyssey about the dawn of artificial consciousness and the evolution of sin. Set at the intersection of the near future and the reimagined past, it explores a world in which every human appetite, no matter how noble or depraved, can be indulged.', '', 'https://image.tmdb.org/t/p/w300//y55oBgf6bVMI7sFNXwJDrSIxPQt.jpg'),
...
(181812, 3, 'Star Wars: The Rise of Skywalker', 'film', 'publié', '2019-12-18', 'The surviving Resistance faces the First Order once again as the journey of Rey, Finn and Poe Dameron continues. With the power and knowledge of generations behind them, the final battle begins.', 'http://www.youtube.com/embed/adzYW5DZoWs', 'https://image.tmdb.org/t/p/w300//db32LaOibwEliAmSL2jjDF6oDdj.jpg'),
...
(508439, 3, 'Onward', 'film', 'publié', '2020-02-29', 'In a suburban fantasy world, two teenage elf brothers embark on an extraordinary quest to discover if there is still a little magic left out there.', 'http://www.youtube.com/embed/x8DKg_fsacM', 'https://image.tmdb.org/t/p/w300//f4aul3FyD3jv3v4bul1IrkWZvzq.jpg'),
(509585, 3, '7500', 'film', 'publié', '2019-12-26', 'When terrorists try to seize control of a Berlin-Paris flight, a soft-spoken young American co-pilot struggles to save the lives of the passengers and crew while forging a surprising connection with one of the hijackers.', 'http://www.youtube.com/embed/Z5Vz9nPw2lg', 'https://image.tmdb.org/t/p/w300//nrW048JoWofimI5AKXDTBzvxqRr.jpg'),
...
(707886, 3, 'Feel the Beat', 'film', 'publié', '2020-06-19', 'After failing to make it on Broadway, April returns to her hometown and reluctantly begins training a misfit group of young dancers for a competition.', 'http://www.youtube.com/embed/PhLSDnxLp-M', 'https://image.tmdb.org/t/p/w300//wXBxd34dFEx6Wruf5Ch5jKLBxDi.jpg');
